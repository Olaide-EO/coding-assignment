...
describe('Portal', () => {
  it('should append container to document body', () => {
    ...
    expect(elements[1]).toHaveAttribute('movie-portal-container')
  })
  ...
  it('should render children', () => {
    ...
    expect(children.parentNode).toHaveAttribute('movie-portal-container')
  })
  ...
  it('should remove DOM element when unmounted', () => {
    ...
    expect(document.querySelector('[movie-portal-container]')).toBeNull()
  })
})
